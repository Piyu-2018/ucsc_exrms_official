...
INSERT INTO `exam_mark` (`mark_id`, `academic_yr`, `degree`, `course_name`, `sub_mark`, `assignment_mark`, `grade`, `total_mark`, `director_status`, `head_of_exam_status`, `sar_status`, `exam_sem_id`, `director_id`, `head_of_exam_id`, `sar_id`, `index_no`, `course_id`) VALUES
(1, '2020/2021', 'Computer Science (Bsc)\r\n', 'Software Quality Assurance', 70, 80, 'A', 85, 'Approved', 'Approved', 'Released', 1, 1, 1, 1, 19020945, 0),
(2, '', '', '', 0, 0, '', 0, '', '', '', 0, 0, 0, 0, 19001411, 1),
(3, '', '', '', 0, 0, '', 0, '', '', '', 0, 0, 0, 0, 19001428, 1);
...
(2, 2, 20, 21, 22, 23, 0, 0, 0, 0),
(3, 3, 25, 25, 25, 25, 0, 0, 0, 0);
...
--
-- AUTO_INCREMENT for table `exam_question_mark`
--
ALTER TABLE `exam_question_mark`
