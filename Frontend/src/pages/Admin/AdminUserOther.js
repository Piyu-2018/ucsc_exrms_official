...
import AdminUserOtherTable from "../../Component/Admin/AdminUserOtherTable";
      ...
      <Box>
        ...
        <Grid container spacing={1} justifyContent="space-between">
          ...
          <Grid item xs={8} sm={10}>
            ...
            <AdminButtonGroup />
            <br></br>
            <Typography sx={{ mr: "800px", color: "#06283D" }} variant="h5">
              Users / Other Executives
            </Typography>
            <AdminUserOtherTable />
          </Grid>
        </Grid>
